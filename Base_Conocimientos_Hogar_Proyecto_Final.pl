...
% Booleano de existencia de un objeto en un lugar, recibe una tupla de atributos propia del objeto a buscar 
% Ej: existe_mesa_en( (Color,Forma,Material), Lugar ) -> existe_mesa_en( (blanco,rectangular,metal), sala )

	existe_mesa_en((Color,Forma,Material),Lugar):-
		findall(true,mesa(Color,Forma,Material,Lugar),Mesas),
		length(Mesas,Longitud), 
	 	(Longitud >= 1 -> 
	 		writeln('Si existe. ');
	 	writeln('No existe')).

	existe_sofa_en((Color,Forma),Lugar):-
		findall(true,sofa(Color,Forma,Lugar),Sofas), 
		length(Sofas,Longitud), 
	 	(Longitud >= 1 -> 
	 		writeln('Si existe. ');
	 	writeln('No existe')).

	existe_tele_en((Tipo),Lugar):-
		findall(true,television(Tipo,Lugar),Teles), 
		length(Teles,Longitud), 
	 	(Longitud >= 1 -> 
	 		writeln('Si existe. ');
	 	writeln('No existe')).

	existe_silla_en((Color, Material),Lugar):-
		findall(true,silla(Color, Material, Lugar),Sillas), 
		length(Sillas,Longitud), 
	 	(Longitud >= 1 -> 
	 		writeln('Si existe. ');
	 	writeln('No existe')).	
	
	existe_lampara_en((Tipo,Forma),Lugar):-
		findall(true,lampara(Tipo,Forma,Lugar),Lamparas),
		length(Lamparas,Longitud), 
	 	(Longitud >= 1 -> 
	 		writeln('Si existe. ');
	 	writeln('No existe')).	

	existe_cama_en((Tipo),Lugar):-
		findall(true,cama(Tipo,Lugar),Camas), 
		length(Camas,Longitud), 
	 	(Longitud >= 1 -> 
	 		writeln('Si existe. ');
	 	writeln('No existe')).	

	existe_espejo_en((Tamano),Lugar):-
		findall(true,espejo(Tamano,Lugar),Espejos), 
		length(Espejos,Longitud), 
	 	(Longitud >= 1 -> 
	 		writeln('Si existe. ');
	 	writeln('No existe')).	

	existe_pintura_en((Tamano,Imagen),Lugar):-
		findall(true,pintura(Tamano,Imagen,Lugar),Pinturas),
		length(Pinturas,Longitud), 
	 	(Longitud >= 1 -> 
	 		writeln('Si existe. ');
	 	writeln('No existe')).	

	existe_maceta_en((Tamano),Lugar):-
		findall(true,maceta(Tamano,Lugar),Macetas),
		length(Macetas,Longitud), 
	 	(Longitud >= 1 -> 
	 		writeln('Si existe. ');
	 	writeln('No existe')).	

	existe_florero_en((Tamano),Lugar):-
		findall(true,florero(Tamano,Lugar),Floreros),
		length(Floreros,Longitud), 
	 	(Longitud >= 1 -> 
	 		writeln('Si existe. ');
	 	writeln('No existe')).	

	existe_horno_en((Color, Tipo),Lugar):-
		findall(true,horno(Color, Tipo, Lugar),Hornos), 
		(existe((Color, Tipo),Hornos) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_retrete_en((Color),Lugar):-
		findall(true,retrete(Color,Lugar),Retretes), 
		(existe((Color),Retretes) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_regadera_en((Color),Lugar):-
		findall(true,regadera(Color,Lugar),Regaderas), 
		(existe((Color),Regaderas) -> 
			writeln('Si existe. ');
		writeln('No existe')).
	
	existe_tapete_en((Color, Tamano),Lugar):-
		findall(true,tapete(Color, Tamano, Lugar),Tapetes), 
		(existe((Color, Tamano),Tapetes) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_ventana_en((Tamano),Lugar):-
		findall(true,ventana(Tamano,Lugar),Ventanas), 
		(existe((Tamano),Ventanas) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_reloj_en((Color, Tamano),Lugar):-
		findall(true,reloj(Color, Tamano, Lugar),Relojes), 
		(existe((Color, Tamano),Relojes) -> 
			writeln('Si existe. ');
		writeln('No existe')).	

	existe_gabinete_en((Color, Tamano),Lugar):-
		findall(true,gabinete(Color,Tamano,Lugar),Gabinetes), 
		(existe((Color, Tamano),Gabinetes) -> 
			writeln('Si existe. ');
		writeln('No existe')).	

	existe_refrigerador_en((Color),Lugar):-
		findall(true,refrigerador(Color,Lugar),Refrigeradores), 
		(existe((Color),Refrigeradores) -> 
			writeln('Si existe. ');
		writeln('No existe')).		

	existe_lavabo_en((Color, Tipo),Lugar):-
		findall(true,lavabo(Color,Tipo,Lugar),Lavabos), 
		(existe((Color, Tipo),Lavabos) -> 
			writeln('Si existe. ');
		writeln('No existe')).
