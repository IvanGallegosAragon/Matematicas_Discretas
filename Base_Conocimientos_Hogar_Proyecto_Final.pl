...
% Ej: existe_mesa_en( (Color,Forma,Material), Lugar ) -> existe_mesa_en( (blanco,rectangular,metal), sala )
	...
	existe_mesa_en((Color,Forma,Material),Lugar):-
		findall((Color,Forma,Material),mesa(Color,Forma,Material,Lugar),Mesas),
		(existe((Color,Forma,Material),Mesas) -> 
			writeln('Si existe. ');
		writeln('No existe') ).

	existe_sofa_en((Color,Forma),Lugar):-
		findall((Color,Forma),sofa(Color,Forma,Lugar),Sofas), 
		(existe((Color,Forma),Sofas) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_tele_en((Tipo),Lugar):-
		findall((Tipo),television(Tipo,Lugar),Teles), 
		(existe((Tipo),Teles) -> 
		 	writeln('Si existe. ');
		writeln('No existe')).

	existe_silla_en((Color, Material),Lugar):-
		findall((Color, Material),silla(Color, Material, Lugar),Sillas), 
		(existe((Color, Material),Sillas) -> 
			writeln('Si existe. ');
		writeln('No existe')).	
	
	existe_lampara_en((Tipo,Forma),Lugar):-
		findall((Tipo,Forma),lampara(Tipo,Forma,Lugar),Lamparas),
		(existe((Tipo,Forma),Lamparas) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_cama_en((Tipo),Lugar):-
		findall((Tipo),cama(Tipo,Lugar),Camas), 
		(existe((Tipo),Camas) -> 
			writeln('Si existe. ');
		writeln('No existe')).	

	existe_espejo_en((Tamano),Lugar):-
		findall((Tamano),espejo(Tamano,Lugar),Espejos), 
		(existe((Tamano),Espejos) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_pintura_en((Tamano,Imagen),Lugar):-
		findall((Tamano,Imagen),pintura(Tamano,Imagen,Lugar),Pinturas),
		(existe((Tamano,Imagen),Pinturas) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_maceta_en((Tamano),Lugar):-
		findall((Tamano),maceta(Tamano,Lugar),Macetas),
		(existe((Tamano),Macetas) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_florero_en((Tamano),Lugar):-
		findall((Tamano),florero(Tamano,Lugar),Floreros),
		(existe((Tamano),Floreros) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_horno_en((Color, Tipo),Lugar):-
		findall((Color, Tipo),horno(Color, Tipo, Lugar),Hornos), 
		(existe((Color, Tipo),Hornos) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_retrete_en((Color),Lugar):-
		findall((Color),retrete(Color,Lugar),Retretes), 
		(existe((Color),Retretes) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_regadera_en((Color),Lugar):-
		findall((Color),regadera(Color,Lugar),Regaderas), 
		(existe((Color),Regaderas) -> 
			writeln('Si existe. ');
		writeln('No existe')).
	
	existe_tapete_en((Color, Tamano),Lugar):-
		findall((Color, Tamano),tapete(Color, Tamano, Lugar),Tapetes), 
		(existe((Color, Tamano),Tapetes) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_ventana_en((Tamano),Lugar):-
		findall((Tamano),ventana(Tamano,Lugar),Ventanas), 
		(existe((Tamano),Ventanas) -> 
			writeln('Si existe. ');
		writeln('No existe')).

	existe_reloj_en((Color, Tamano),Lugar):-
		findall((Color, Tamano),reloj(Color, Tamano, Lugar),Relojes), 
		(existe((Color, Tamano),Relojes) -> 
			writeln('Si existe. ');
		writeln('No existe')).	

	existe_gabinete_en((Color, Tamano),Lugar):-
		findall((Color, Tamano),gabinete(Color,Tamano,Lugar),Gabinetes), 
		(existe((Color, Tamano),Gabinetes) -> 
			writeln('Si existe. ');
		writeln('No existe')).	

	existe_refrigerador_en((Color),Lugar):-
		findall((Color),refrigerador(Color,Lugar),Refrigeradores), 
		(existe((Color),Refrigeradores) -> 
			writeln('Si existe. ');
		writeln('No existe')).		

	existe_lavabo_en((Color, Tipo),Lugar):-
		findall((Color, Tipo),lavabo(Color,Tipo,Lugar),Lavabos), 
